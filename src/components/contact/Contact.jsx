...
const addressData = [
  {
    icon: faLocationDot,
    title: "Address",
    description: "Vishwakarma Institute of Technology, Pune",
  },
  {
    icon: faEnvelope,
    title: "My Email",
    description: "adharashivkar17@gmail.com",
  },
  {
    icon: faPhone,
    title: "Call Me Now",
    description: "+91 9404210220",
  },
];
      ...
      >
        <div className="flex flex-col-reverse lg:gap-5 xl:gap-25.75 lg:flex-row justify-between">
          <div>
            ...
            <div className="w-full max-lg:text-center max-md:mb-4 mt-8 flex justify-center lg:justify-start">
              <SocialMedia />
            </div>
          </div>
